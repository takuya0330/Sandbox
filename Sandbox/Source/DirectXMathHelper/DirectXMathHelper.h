...
_ARITHMETIC_OPERATOR(XMFLOAT2, 2, +);
_ARITHMETIC_OPERATOR(XMFLOAT2, 2, -);
_ARITHMETIC_OPERATOR(XMFLOAT2, 2, *);
_ARITHMETIC_OPERATOR(XMFLOAT2, 2, / );
_ARITHMETIC_OPERATOR(XMFLOAT3, 3, +);
_ARITHMETIC_OPERATOR(XMFLOAT3, 3, -);
_ARITHMETIC_OPERATOR(XMFLOAT3, 3, *);
_ARITHMETIC_OPERATOR(XMFLOAT3, 3, / );
_ARITHMETIC_OPERATOR(XMFLOAT4, 4, +);
_ARITHMETIC_OPERATOR(XMFLOAT4, 4, -);
_ARITHMETIC_OPERATOR(XMFLOAT4, 4, *);
_ARITHMETIC_OPERATOR(XMFLOAT4, 4, / );

_ASSIGNMENT_OPERATOR(XMFLOAT2, 2, +=);
_ASSIGNMENT_OPERATOR(XMFLOAT2, 2, -=);
_ASSIGNMENT_OPERATOR(XMFLOAT2, 2, *=);
_ASSIGNMENT_OPERATOR(XMFLOAT2, 2, /= );
_ASSIGNMENT_OPERATOR(XMFLOAT3, 3, +=);
_ASSIGNMENT_OPERATOR(XMFLOAT3, 3, -=);
_ASSIGNMENT_OPERATOR(XMFLOAT3, 3, *=);
_ASSIGNMENT_OPERATOR(XMFLOAT3, 3, /= );
_ASSIGNMENT_OPERATOR(XMFLOAT4, 4, +=);
_ASSIGNMENT_OPERATOR(XMFLOAT4, 4, -=);
_ASSIGNMENT_OPERATOR(XMFLOAT4, 4, *=);
_ASSIGNMENT_OPERATOR(XMFLOAT4, 4, /= );

_ARITHMETIC_OPERATOR(XMINT2, 2, +);
_ARITHMETIC_OPERATOR(XMINT2, 2, -);
_ARITHMETIC_OPERATOR(XMINT2, 2, *);
_ARITHMETIC_OPERATOR(XMINT2, 2, / );
_ARITHMETIC_OPERATOR(XMINT3, 3, +);
_ARITHMETIC_OPERATOR(XMINT3, 3, -);
_ARITHMETIC_OPERATOR(XMINT3, 3, *);
_ARITHMETIC_OPERATOR(XMINT3, 3, / );
_ARITHMETIC_OPERATOR(XMINT4, 4, +);
_ARITHMETIC_OPERATOR(XMINT4, 4, -);
_ARITHMETIC_OPERATOR(XMINT4, 4, *);
_ARITHMETIC_OPERATOR(XMINT4, 4, / );

_ASSIGNMENT_OPERATOR(XMINT2, 2, +=);
_ASSIGNMENT_OPERATOR(XMINT2, 2, -=);
_ASSIGNMENT_OPERATOR(XMINT2, 2, *=);
_ASSIGNMENT_OPERATOR(XMINT2, 2, /= );
_ASSIGNMENT_OPERATOR(XMINT3, 3, +=);
_ASSIGNMENT_OPERATOR(XMINT3, 3, -=);
_ASSIGNMENT_OPERATOR(XMINT3, 3, *=);
_ASSIGNMENT_OPERATOR(XMINT3, 3, /= );
_ASSIGNMENT_OPERATOR(XMINT4, 4, +=);
_ASSIGNMENT_OPERATOR(XMINT4, 4, -=);
_ASSIGNMENT_OPERATOR(XMINT4, 4, *=);
_ASSIGNMENT_OPERATOR(XMINT4, 4, /= );

_ARITHMETIC_OPERATOR(XMUINT2, 2, +);
_ARITHMETIC_OPERATOR(XMUINT2, 2, -);
_ARITHMETIC_OPERATOR(XMUINT2, 2, *);
_ARITHMETIC_OPERATOR(XMUINT2, 2, / );
_ARITHMETIC_OPERATOR(XMUINT3, 3, +);
_ARITHMETIC_OPERATOR(XMUINT3, 3, -);
_ARITHMETIC_OPERATOR(XMUINT3, 3, *);
_ARITHMETIC_OPERATOR(XMUINT3, 3, / );
_ARITHMETIC_OPERATOR(XMUINT4, 4, +);
_ARITHMETIC_OPERATOR(XMUINT4, 4, -);
_ARITHMETIC_OPERATOR(XMUINT4, 4, *);
_ARITHMETIC_OPERATOR(XMUINT4, 4, / );

_ASSIGNMENT_OPERATOR(XMUINT2, 2, +=);
_ASSIGNMENT_OPERATOR(XMUINT2, 2, -=);
_ASSIGNMENT_OPERATOR(XMUINT2, 2, *=);
_ASSIGNMENT_OPERATOR(XMUINT2, 2, /= );
_ASSIGNMENT_OPERATOR(XMUINT3, 3, +=);
_ASSIGNMENT_OPERATOR(XMUINT3, 3, -=);
_ASSIGNMENT_OPERATOR(XMUINT3, 3, *=);
_ASSIGNMENT_OPERATOR(XMUINT3, 3, /= );
_ASSIGNMENT_OPERATOR(XMUINT4, 4, +=);
_ASSIGNMENT_OPERATOR(XMUINT4, 4, -=);
_ASSIGNMENT_OPERATOR(XMUINT4, 4, *=);
_ASSIGNMENT_OPERATOR(XMUINT4, 4, /= );
