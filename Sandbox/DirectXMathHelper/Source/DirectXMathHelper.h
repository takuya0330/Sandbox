...
#define _ARITHMETIC_OPERATOR(TYPE, N, OP)                                                \
	inline static constexpr TYPE operator OP(const TYPE& v1, const TYPE& v2)             \
	{                                                                                    \
		return TYPE(_ARITHMETIC_V(N, OP));                                               \
	}                                                                                    \
	inline static constexpr TYPE operator OP(const TYPE& v1, const decltype(TYPE::x) v2) \
	{                                                                                    \
		return TYPE(_ARITHMETIC_T(N, OP));                                               \
	}
...
#define _ASSIGNMENT_OPERATOR(TYPE, N, OP)                                \
	inline static void operator OP(TYPE& v1, const TYPE& v2)             \
	{                                                                    \
		_ASSIGNMENT_V(N, OP);                                            \
	}                                                                    \
	inline static void operator OP(TYPE& v1, const decltype(TYPE::x) v2) \
	{                                                                    \
		_ASSIGNMENT_T(N, OP);                                            \
	}
...
#define _XMH_OPERATORS(TYPE)            \
	_XMH_ARITHMETIC_OPERATORS(TYPE, 2); \
	_XMH_ARITHMETIC_OPERATORS(TYPE, 3); \
	_XMH_ARITHMETIC_OPERATORS(TYPE, 4); \
	_XMH_ASSIGNMENT_OPERATORS(TYPE, 2); \
	_XMH_ASSIGNMENT_OPERATORS(TYPE, 3); \
	_XMH_ASSIGNMENT_OPERATORS(TYPE, 4)

_XMH_OPERATORS(XMFLOAT);
_XMH_OPERATORS(XMINT);
_XMH_OPERATORS(XMUINT);
